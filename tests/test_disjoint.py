...
def test_disjoint_logic():
    ...
    res_cum = neighborlist_rs.build_neighborlists_multi(cell, pos, cutoffs, disjoint=False)
    ...
    # 2. Disjoint (Shells)
    res_dis = neighborlist_rs.build_neighborlists_multi(cell, pos, cutoffs, disjoint=True)
...
def test_unsorted_cutoffs():
    ...
    ref_small = neighborlist_rs.build_neighborlists(cell, pos, 3.0)["edge_index"].shape[1]
    ref_total = neighborlist_rs.build_neighborlists(cell, pos, 5.0)["edge_index"].shape[1]
